...
const LeavesTable = () => {
  // States
  const [addEditLeaveOpen, setAddEditLeaveOpen] = useState(false)
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('leave_purpose', {
        header: 'Leave Purpose',
        cell: ({ row }) => (
          <Typography color='text.primary'>
            {row.original?.leave_purpose}
          </Typography>
        )
      }),
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            <IconButton onClick={() => {setAddEditLeaveOpen(!addEditLeaveOpen); setEditLeaveData(row.original)}}>
        ...
        <div className='flex justify-between flex-col items-start md:flex-row md:items-center p-6 border-bs gap-4'>
          ...
          <div className='flex flex-col sm:flex-row max-sm:is-full items-start sm:items-center gap-4'>
            ...
            <Button
              ...
              onClick={() => setAddEditLeaveOpen(!addEditLeaveOpen)}
              className='max-sm:is-full'
            >
              Add New Leave
            </Button>
